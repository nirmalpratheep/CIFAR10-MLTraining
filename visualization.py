"""
Comprehensive visualization and metrics module for CIFAR-10 training.
...
class TrainingVisualizer:
    ...
    def __init__(self, save_dir: str = "./plots", class_names: List[str] = None):
...
def evaluate_model_comprehensive(model, device, test_loader, criterion, class_names=None):
...
def create_training_summary(train_losses, train_acc, test_losses, test_acc, 
                          learning_rates=None, save_dir="./plots"):
    ...
    print("✅ Training summary plots generated successfully!")
    print(f"📁 All plots saved in: {save_dir}")


def create_evaluation_summary(model, device, test_loader, criterion, save_dir="./plots"):
    ...
    eval_results = evaluate_model_comprehensive(model, device, test_loader, criterion)
